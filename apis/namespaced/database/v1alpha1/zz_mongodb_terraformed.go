...
// GetInitParameters of this Mongodb
func (tr *Mongodb) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this Mongodb
func (tr *Mongodb) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
