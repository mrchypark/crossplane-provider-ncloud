...
func (mg *LaunchConfiguration) GetTerraformResourceType() string {
	return "ncloud_launch_configuration"
}
...
func (tr *LaunchConfiguration) LateInitialize(attrs []byte) (bool, error) {
	...
	opts = append(opts, resource.WithNameFilter("ServerImageProductCode"))
	opts = append(opts, resource.WithNameFilter("ServerProductCode"))
